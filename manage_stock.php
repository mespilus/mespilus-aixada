...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	...
	$(function(){
		...
		/**
		 *	product TPV search barcode functionality 
		 */
		$("#tpv").keyup(function(e){
					var minLength = 12; 						//search with min of X characters
					...
					if (searchStr.length >= minLength){
						...
						$('.loadAnimShop').show();
					  	$('#product_list_provider tbody').xml2html("reload",{
							params: 'oper=getShopProducts&provider_id=-2&like='+searchStr+'&date=1234-01-01',
							complete : function(rowCount){
								if (rowCount == 0){
									$('#searchTips').show();
								}
	...
	<div id="stagewrap">
				...
				<div id="titlewrap" class="ui-widget">
		    		...
		    		<div id="titleRightCol50">
						...
						<p class="floatRight  overviewElements"><?php echo $Text['search_tpv'];?>: <input id="tpv" class="ui-widget-contentyellow ui-corner-all"/></p>						
