...
$Text['loading'] = "Si us plau, espereu mentre es carreguen les dades...";
$Text['search'] = "Cerca";
$Text['tpv'] = "Codi de barres";
$Text['id'] = "id";
$Text['uf_short'] = "CIST";
...
$Text['by_category'] = "Per categoria";
...
$Text['head_ti_manage_uf'] = "Cistelles/Membres";
 ...
 */
$Text['ti_mng_activate_products'] = "Es poden demanar els següents productes PER al dia ";
...
$Text['ti_shop'] = "Compra articles d'estoc ";
...
$Text['ti_report_torn'] = "Resum de la facturació d'avui";
...
$Text['email'] = "Correu-e (mespilus)";
$Text['web'] = "Correu-e extern";
...
$Text['mon_op_deposit_uf'] = 'Ingrés de cistella';
$Text['mon_op_deposit_others'] = 'Ingrés altres';
$Text['mon_op_debit_uf'] = 'Càrrec a cistella';
$Text['mon_op_pay_pr'] = 'Pagament a Prv.';
$Text['mon_op_refund_uf'] = 'Devolució a cistella.';
...
$Text['mon_op_a_debit_uf'] = 'Anul·lar Càrrec a cistella';
...
$Text['mon_desc_deposit_uf'] = 'Dipòsit de cistella';
$Text['mon_desc_deposit_from_uf'] = 'Dipòsit de cistella #{uf_from_id} {comment}';
$Text['mon_desc_payment'] = 'Pagament a proveïdor';
$Text['mon_desc_payment_to_provider'] = 'Pagament a #{provider_to_id} {comment}';
$Text['mon_desc_refund_to_uf'] = 'Restitució a cistella #{uf_to_id} {comment}';
...
$Text['mon_from'] = 'De';
$Text['mon_to'] = 'A';
$Text['mon_all_active_uf'] = '* Totes les cistelles actives *';
...
$Text['mon_uf_balances'] = "Saldo de les cistelles";
...
$Text['negativeUfs']= "Cistelles en negatiu";
...
$Text['nav_mng'] = "Gestiona";
	...
	$Text['nav_mng_db'] = "Còpia de seguretat. Base de dades";
...
$Text['msg_please_set_ufid_deposit'] = "No s'ha definit l'ID de la cistella. Heu de triar una cistella per fer el dipòsit!";
 ...
 */
$Text['SET_ME'] = 'SET_ME';
$Text['prdcat_fruita'] = "Fruita i Verdura";
$Text['prdcat_carns'] = "Carns";
$Text['prdcat_lactics'] = "Làctics i liquats vegetals";
$Text['prdcat_ous'] = "Ous";
$Text['prdcat_peix'] = "Peix";
$Text['prdcat_pa'] = "Pa";
$Text['prdcat_vins'] = "Vins, caves i cervesa";
$Text['prdcat_conserves'] = "Conserves";
$Text['prdcat_olis'] = "Olis i vinagre";
$Text['prdcat_arros'] = "Arros, cereals, llegums i llavors";
$Text['prdcat_sucres'] = "Sucres, mels, edulcorants i sal";
$Text['prdcat_pasta'] = "Gra i pasta";
$Text['prdcat_postres'] = "Postres i dolços";
$Text['prdcat_fruitsecs'] = "Fruits secs";
$Text['prdcat_protvegetal'] = "Proteïna vegetal";
$Text['prdcat_galetes'] = "Galetes i snacks";
$Text['prdcat_infusions'] = "Cafè, tè i infusions";
$Text['prdcat_homeopatia'] = "Homeopatia";
$Text['prdcat_naturopatia'] = "Naturopatia";
$Text['prdcat_cosmetics'] = "Cosmètics";
$Text['prdcat_higiene'] = "Bany i higiene personal";
$Text['prdcat_neteja'] = "Neteja" ;
$Text['prdcat_precuinats'] = "Precuinats";
...
$Text['fax'] = 'Fax';
$Text['responsible_mem_name'] = 'Soci responsable';
...
$Text['rev_tax_type'] = "Tipus de marge";
...
$Text['cart_id'] = "Id compra";
$Text['msg_several_carts'] = "La cistella seleccionada té més d'una compra pendent de validar. Tria'n una si us plau:";
$Text['transfer_type'] = "Tipus";
$Text['todays_carts'] = "Compres d'avui";
$Text['week_carts'] = "Compres de la setmana";
$Text['head_ti_torn'] = "Resum de la facturació"; 
$Text['btn_validate'] = "Validar";
$Text['desc_validate'] = "Validar compres actuals i antigues de les cistelles. Ingressar efectiu.";
...
$Text['desc_stats'] = "Descarrega un informe resumit de la facturació actual, incloent-hi incidents, cistelles en negatiu, despesa total i productes amb estoc negatiu";
...
$Text['purchase_details'] = "Detall de la compra nº";
$Text['filter_uf'] = "Filtra per compra";
$Text['purchase_uf'] = "Compra del soci";
$Text['quantity_short'] = "Qu";
$Text['incl_iva'] = "incl. IVA";
$Text['incl_revtax'] = "incl. Marge";
...
$Text['msg_err_mentoruf'] = "La cistella no pot ser amfitriona de sí mateixa!";
...
$Text['ti_mng_hu_members'] = "Gestiona cistelles i els seus membres"; 
$Text['list_ufs'] = "Llistat de cistelles";
$Text['search_members'] = "Busca un membre";
$Text['member_pl'] = "Membres";
$Text['mng_members_uf'] = "Gestiona els membres de la cistella ";
$Text['uf_name'] = "Nom";
...
$Text['search_tpv'] = "Codi de barres";
...
$Text['msg_con_disValitate'] =
    ...
    <li>s'anotaran els productes com a compres de les cistelles en la data de la comanda</li>
    <li>i els imports de les compres s'anotarà com a deute als comptes de les cistelles</li>
    </ul>";
$Text['msg_con_disValitate_prvInv'] =
    "Distribuir i validar no es pot anular!!:<ul>
    <li>s'anotaran els productes com a compres de les cistelles en la data de la comanda,</li>
    <li>els imports de les compres s'anotarà com a deute als comptes de les cistelles</li>
...
$Text['msg_confirm_move'] = "ATENCIÓ! Cal que la data de compra sigui un <font color=\"red\"><b>DIMECRES</b></font>. Comproveu la data i seleccioneu, si cal, un altre dimecres al calendari";
$Text['alter_date'] = "Seleccioneu el DIMECRES per distribuir la compra a les cistelles";
...
$Text['left_ordering'] = " dies per demanar."; //as in 4 days left for ordering
$Text['ostat_closed'] = "La comanda està tancada";
$Text['ostat_desc_fin_send'] = "La comanda s'ha tancat. La referència és: #";
$Text['msg_err_past'] = "Cal que seleccioneu un dimecres! <br/> A partir de dimecres vinent.";
...
$Text['withdraw_uf'] = "Retirar diners de compte de cistella"; 
...
// Orders
$Text['or_prv_prices'] = 'Preus del proveïdor (sense marge)';
...
$Text['msg_remember_stock'] = 'Recordeu que les quantitats que canvieu aquí <b>substitueixen</b> les respectives quantitats a la cistella. <b>NO</b> les incrementen!';
?>