		...
		//load purchase detail (products and quantities)
			$('#tbl_purchaseDetail tbody').xml2html('init',{
				...
				complete : function(rowCount){
					...
					$('#fact_Iva0').text(totals['Fact_Iva0']);
					
					
					$('#fact_Iva1B').text(totals['Fact_Iva1']);
					$('#fact_Iva2B').text(totals['Fact_Iva2']);
					$('#fact_Iva3B').text(totals['Fact_Iva3']);
					$('#fact_Iva0B').text(totals['Fact_Iva0']);
				...
				<table id="tbl_purchaseDetail" class="tblListingGrid" currentShopId="" currenShopDate="">
					...
					<tfoot>
						...
						<tr>
							...
							<td id="fact_Iva3" class="boldStuff"></td>
						</tr>
						<tr>
						
							<td colspan="7" class="boldStuff"><?php echo $Text['incl_fiva0']; ?></td>
							<td id="fact_Iva0" class="boldStuff dblBorderBottom"></td>
						</tr>
						
						
						<tr>
							<td colspan="1" class="boldStuff dblBorderBottom"><p>Facturació</p></td>
						</tr>
						
						
						
						<tr>
							<td colspan="1"><font color="#ff0000"><p><b>C</b><span class="setUfId boldStuff"></span></p></font></td>
						</tr>
						
						
						<tr>
							<td colspan="1"><p><span class="setShopDate2 boldStuff"></span></p></td>
						</tr>
						...
						<tr>
							...
							<td id="totalB" class="boldStuff"></td>
						</tr>
						...
						<tr>
							...
							<td id="fact_Iva1B" class="boldStuff"></td>
						</tr>
						<tr>
						
							<td id="fact_Iva2B" class="boldStuff"></td>
						</tr>
						<tr>
						
							<td id="fact_Iva3B" class="boldStuff"></td>
						</tr>
						<tr>
						
							<td id="fact_Iva0B" class="boldStuff dblBorderBottom"></td>
						</tr>
