			...
			$.ajax({
				...
				success: function(txt){
					...
					for (var i=0; i<gdates.length; i++){
						...
						var dayName = $.datepicker.formatDate('D', dd);  //short date day name
						var pastclass = (dd < today)||(dayName == 'Dln')||(dayName == 'Dmt')||(dayName == 'Djs')||(dayName == 'Dvn')||(dayName == 'Dsb')||(dayName == 'Dug')? 'dim40':'';  //only allow Wednesdays for Mespilus
