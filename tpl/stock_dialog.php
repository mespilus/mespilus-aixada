...
<input type="text" name="stockValue" id="stock_value" class="ui-widget-contentyellow ui-corner-all inputTxtTiny freeInput"/> <span id="setStockUnit"></span>
</p>
<br/>
<table class="tblForms">
	...
	<tr>
		...
		<td>
			<input type="text" name="description" id="stock_movement_description" value="" class="ui-widget-contentyellow ui-corner-all inputTxtMiddle">
		</td>
	</tr>
<tr></tr>
</table>
